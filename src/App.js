...
export default function App() {
  ...
  const S = {
    ...
    deleteBtn:{ width:"100%", padding:12, background:"#fee2e2", color:"#ef4444", border:"none", borderRadius:10, fontWeight:700, fontSize:14, cursor:"pointer", fontFamily:"inherit", marginTop:16 }, left:"50%", transform:"translateX(-50%)", width:"100%", maxWidth:430, background:"#fff", borderTop:"1px solid #e5e7eb", display:"flex", zIndex:100 },
